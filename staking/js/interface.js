...
var contractAddress = "0x69579157aad69C3205E96b3F220D06dC94A86F43";
var DivsAddress = "0xf7c11F0049e76A3C0a6b98f46dA4500c6B3ae5B8";

function investDVN(tokens, callback) {
    var contractAbi = web3.eth.contract(DDabi);
    var myContract = contractAbi.at(DivsAddress);
    var outputData = myContract.transferAndCall.getData(contractAddress, tokens, 0x0);
    var endstr = web3.eth.sendTransaction({to:DivsAddress, from:null, data: outputData},
...
function partialDivestDVN(amount, callback) {
    var contractAbi = web3.eth.contract(abi);
    var myContract = contractAbi.at(contractAddress);
...
function getDVNBalance(callback) {
    var contractAbi = web3.eth.contract(DDabi);
    var myContract = contractAbi.at(DivsAddress);
    var outputData = myContract.myTokens.getData();
    var endstr = web3.eth.call({to:DivsAddress, from:null, data: outputData},
    function(error, result) {
        if (!error) {
